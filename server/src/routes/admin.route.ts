...
/**
 * A GET route to check if the requestor is an admin. Checks first if the requestor is a authenticated.
 */
...
/**
 * A delete route to delete a user. Checks first if the requestor is a authenticated and is an admin.
